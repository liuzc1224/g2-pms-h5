...
export class DefaultComponent implements OnInit{
    ...
    initChart_first(data?){
        ...
        const option = {
            ...
            legend: {
                data:[text['registerUserCount'],text['withdrawDepositCount'],text['withdrawDepositAmount'] , text['borrowUserCount']]
            },
            grid: {
                left: '3%',
                right: '4%',
