...
export class StaffComponent implements OnInit{
    ...
    initTable(){
        this.tableData = {
            tableTitle : [
                { name : __this.languagePack['table']['userName'] , type : "text" , reflect : "username" } ,
                { name : __this.languagePack['table']['mobile'] , type:"text" ,reflect : "phoneNumber"} ,
                { name : __this.languagePack['table']['realName'] , type:"text" ,reflect : "description"} ,
                { name : __this.languagePack['table']['department'] , type:"text" ,reflect : "departmentNames" , filter : item => {
                        let str = '' ;

                        if(item && item.departmentDTOS)
                ...
                { name : __this.languagePack['table']['role'] , type:"text" ,reflect : "roleNames" , filter : item => {
                        let str = '' ;
    ...
    getList(){
        ...
        this.service.getList(this.searchModel)
            .subscribe(
                res => {
    ...
    delete(){
        this.service.deleteStaff(this.stuffId)
            .subscribe(
                res => {
                    if(res['success'] === true){
                        this.msg.operateSuccess() ;
    ...
    getLanguage(){
        this.translate.stream(['common' , 'systemModule.admin.table'])
            .subscribe(
                res => {
    ...
    getRoles(){
        ...
        this.roleService.getList(param)
            .subscribe(
                res => {
                    if(res['success'] === true){
