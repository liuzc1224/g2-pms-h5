...
export class RoleComponent implements OnInit{
    ...
    initTable(){
        this.tableData = {
            tableTitle : [
                { name : __this.languagePack['table']['roleName'] , type : "text" , reflect : "name" } ,
                { name : __this.languagePack['table']['remark'] , type:"text" ,reflect : "description"} ,
            ],
            data : [],
            showIndex : true,
            loading : false ,
    ...
    makeNew(){
        ...
        data.menuIds = this.selectRoles ;
        this.service.addNewRole(data)   
            .subscribe(
                res => {
    ...
    delete(){
        this.service.deleteRole(this.roleId)
            .subscribe(
                res => {
    ...
    save(){
        ...
        postData.menuIds = this.selectRoles ;
    ...
    languagePack : object ;
    getLanguage(){
        this.translate.stream(['common' , 'systemModule.role.table'])
            .subscribe(
                res => {
                    this.languagePack = {
                        common : res['common'] , 
